CREATE EXTERNAL TABLE [blobFull].[DimensionAttributeValueCombination]
(
...
WITH
(
LOCATION = N'Tables/Finance/FinancialDimensions/Main/DimensionAttributeValueCombination/*.csv',
