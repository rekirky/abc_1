create   view [blobTransInc].[TaxOnItem] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[AbatementPercent_IN]=cast([AbatementPercent_IN] as numeric(18,6))
