create   view [blobTransFull].[SAB_ConsJournalEntryLine] as select 
LSN,[AmountCurCredit]=cast([AmountCurCredit] as numeric(18,2))
...
,[RECVERSION]
,[RevenueCategory]
 from blobFull.SAB_ConsJournalEntryLine t
GO
