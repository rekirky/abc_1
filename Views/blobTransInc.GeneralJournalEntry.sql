create   view [blobTransInc].[GeneralJournalEntry] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[AccountingDate]=cast(case when [AccountingDate] < cast('1901-01-01' as date) then null else [AccountingDate] end as date)
