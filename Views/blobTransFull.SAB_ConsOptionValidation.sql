create   view [blobTransFull].[SAB_ConsOptionValidation] as select 
LSN,[AddSalesPriceToBase]=case when [AddSalesPriceToBase]=1 then 'Yes' else 'No' end ,AddSalesPriceToBaseFlag=cast([AddSalesPriceToBase] as bit)
,[BuildingTypeId]
