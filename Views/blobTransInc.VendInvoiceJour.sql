create   view [blobTransInc].[VendInvoiceJour] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[AttorneyDate_RU]=cast([AttorneyDate_RU] as date)
,[AttorneyId_RU]
