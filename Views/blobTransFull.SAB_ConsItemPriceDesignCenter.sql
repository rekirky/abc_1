create   view [blobTransFull].[SAB_ConsItemPriceDesignCenter] as select 
LSN,[AmountPercent]=(select top 1 e.Enum from dbo.Enum e where e.EnumSet='SAB_ConsItemPriceDifferenceAmountType' and e.EnumCode=t.[AmountPercent]) ,AmountPercentEnumID=[AmountPercent]
,[Attribute]
,[AttributeValue]
,[BuildingTypeId]
,[ChangeReason]
...
,[Vendor]
 from blobFull.SAB_ConsItemPriceDesignCenter t
GO
