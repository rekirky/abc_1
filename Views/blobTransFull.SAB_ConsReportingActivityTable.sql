create   view [blobTransFull].[SAB_ConsReportingActivityTable] as select 
LSN,[AmendmentApproval]=case when [AmendmentApproval]=1 then 'Yes' else 'No' end ,AmendmentApprovalFlag=cast([AmendmentApproval] as bit)
...
,[Sorting]
 from blobFull.SAB_ConsReportingActivityTable t
GO
