create   view [blobTransInc].[SAB_ConsOptionCategory] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[AdminOption]=case when [AdminOption]=1 then 'Yes' else 'No' end ,AdminOptionFlag=cast([AdminOption] as bit)
,[CREATEDBY]
...
,[UnitId]
 from stage.SAB_ConsOptionCategory t
GO
