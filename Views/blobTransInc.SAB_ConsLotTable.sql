create   view [blobTransInc].[SAB_ConsLotTable] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[ACCRUED]=case when [ACCRUED]=1 then 'Yes' else 'No' end ,ACCRUEDFlag=cast([ACCRUED] as bit)
,[BuildingTypeId]
