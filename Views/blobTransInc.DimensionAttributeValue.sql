create   view [blobTransInc].[DimensionAttributeValue] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[ActiveFrom]=cast([ActiveFrom] as date)
...
,[RECID]
,[RECVERSION]
 from stage.DimensionAttributeValue t
GO
