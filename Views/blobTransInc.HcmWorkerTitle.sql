create   view [blobTransInc].[HcmWorkerTitle] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[AnniversaryDateTime]=cast([AnniversaryDateTime] as date)
