create   view [blobTransInc].[SAB_ConsCSRequestVendorScheduleAppointment] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[CompleteDateTime]=cast([CompleteDateTime] as date)
