create   view [blobTransFull].[SAB_ConsWorkOrder] as select 
LSN,[Canceled]=case when [Canceled]=1 then 'Yes' else 'No' end ,CanceledFlag=cast([Canceled] as bit)
,[CashDiscCode]
,[ContractDetails]
,[CREATEDBY]
...
,[Vendor]
,[WorkOrderId]
 from blobFull.SAB_ConsWorkOrder t
GO
