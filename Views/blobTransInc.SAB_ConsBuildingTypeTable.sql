create   view [blobTransInc].[SAB_ConsBuildingTypeTable] as select 
DML_Action,Start_LSN,Seq_Val,Instance,[ConsBuildingTypeDescription]
,[ConsBuildingTypeId]
...
,[Type]=(select top 1 e.Enum from dbo.Enum e where e.EnumSet='SAB_ConsBuildingTypeType' and e.EnumCode=t.[Type]) ,TypeEnumID=[Type]
 from stage.SAB_ConsBuildingTypeTable t
GO
